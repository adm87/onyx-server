...
const file_auth_v1_auth_proto_rawDesc = "" +
	...
	"\auser_id\x18\x02 \x01(\tR\x06userId2\x95\x02\n" +
	"\vAuthService\x128\n" +
	...
	"\fRefreshToken\x12\x1c.auth.v1.RefreshTokenRequest\x1a\x16.auth.v1.TokenResponse\x12N\n" +
	"\rValidateToken\x12\x1d.auth.v1.ValidateTokenRequest\x1a\x1e.auth.v1.ValidateTokenResponseB1Z/github.com/you/backend/proto/gen/auth/v1;authv1b\x06proto3"
...
var file_auth_v1_auth_proto_depIdxs = []int32{
	...
	2, // 4: auth.v1.AuthService.Signup:output_type -> auth.v1.TokenResponse
	2, // 5: auth.v1.AuthService.Login:output_type -> auth.v1.TokenResponse
	2, // 6: auth.v1.AuthService.RefreshToken:output_type -> auth.v1.TokenResponse
