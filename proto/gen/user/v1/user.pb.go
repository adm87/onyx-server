...
const file_user_v1_user_proto_rawDesc = "" +
	...
	"\x02id\x18\x01 \x01(\tR\x02id\x12!\n" +
	"\fdisplay_name\x18\x02 \x01(\tR\vdisplayName2\xb2\x01\n" +
	"\vUserService\x127\n" +
	"\n" +
	...
	"\n" +
	"UpdateUser\x12\x1a.user.v1.UpdateUserRequest\x1a\r.user.v1.UserB1Z/github.com/you/backend/proto/gen/user/v1;userv1b\x06proto3"
...
var file_user_v1_user_proto_depIdxs = []int32{
	...
	3, // 2: user.v1.UserService.UpdateUser:input_type -> user.v1.UpdateUserRequest
	0, // 3: user.v1.UserService.CreateUser:output_type -> user.v1.User
	0, // 4: user.v1.UserService.GetUser:output_type -> user.v1.User
	0, // 5: user.v1.UserService.UpdateUser:output_type -> user.v1.User
